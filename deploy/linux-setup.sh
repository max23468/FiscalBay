...
RECONCILE_SERVICE_NAME="ebaycf-reconcile"
RECONCILE_SERVICE_TEMPLATE="${APP_DIR}/deploy/ebaycf-reconcile.service"
RECONCILE_SERVICE_TARGET="/etc/systemd/system/${RECONCILE_SERVICE_NAME}.service"
RECONCILE_TIMER_TEMPLATE="${APP_DIR}/deploy/ebaycf-reconcile.timer"
RECONCILE_TIMER_TARGET="/etc/systemd/system/${RECONCILE_SERVICE_NAME}.timer"
OAUTH_SERVICE_NAME="ebaycf-oauth"
OAUTH_SERVICE_TEMPLATE="${APP_DIR}/deploy/ebaycf-oauth.service"
