...
| Prossimo task eleggibile                                    | Creare il Worker `fiscalbay-test` su `test.fiscalbay.it`; configurare poi Google OAuth dedicato |
...
**Blocco:** servono record iCloud forniti durante il setup, indirizzo umano scelto, primo deploy del Worker su `test.fiscalbay.it`, certificato valido e segreti Auth reali. Il trasporto transazionale Better Auth resta separato dalla casella iCloud; l'invio pubblico resta vincolato al checkpoint Workers Paid.
