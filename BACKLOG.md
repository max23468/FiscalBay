...
| Recovery         | PASS locale / BLOCKED operativo    | Il candidato usa D1 Time Travel, con retention nominale fino a 30 giorni sul piano Paid. Le tre migration applicative e Better Auth sono state rilette nel database D1 locale dopo il ripristino del candidato; tutte le tabelle attese sono presenti. La prova Supabase con dump cifrato e round trip R2 resta evidenza storica sul dataset, ma non definisce il runbook del candidato. Restano da provare backup e restore su una D1 FiscalBay remota, retention, riconciliazione delle cancellazioni o revoche successive allo snapshot e drill conclusivo M9. |
