...
| Prossimo task eleggibile                                    | Rileggere eligibility e condizioni Stripe; scegliere o autorizzare il progetto Google dedicato a FiscalBay |
...
| Blocchi noti iniziali                                       | Stripe non riletto; progetto Google FiscalBay, callback, mittente email, preflight dati e payload eBay sanificato mancanti |
...
| Prossima azione alla ripresa                                | Completare il readback Stripe, poi il progetto Google dedicato e i prerequisiti callback/email           |
