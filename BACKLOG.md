...
| Prossimo task eleggibile                                    | Creare il Worker `fiscalbay-test` su `test.fiscalbay.it` e completare i segreti runtime necessari |
...
**Blocco:** servono il primo deploy del Worker su `test.fiscalbay.it`, certificato valido e segreti Auth residui reali. Il trasporto transazionale Better Auth resta separato dalla casella iCloud; l'invio pubblico resta vincolato al checkpoint Workers Paid.
